...
const RESULTS_DIR = 'control_group/fal/flux-1-dev/results';
...
async function processPrompts() {
  console.log("🎨 Starting Fal AI Flux-Dev batch image generation from prompts.txt");
  ...
  try {
    ...
    for (let i = 0; i < prompts.length; i++) {
      ...
      try {
        ...
        // Generate image with Fal AI Flux-Dev (optimized settings)
    ...
    // Save summary report
    const reportText = `# Fal AI Flux-Dev Batch Image Generation Report
...
`;
    ...
    console.log("\n🎉 Fal AI Flux-Dev batch processing completed!");
    ...
    console.error("❌ Fal AI Flux-Dev batch processing failed:", error.message);
    throw error;
  }
}
