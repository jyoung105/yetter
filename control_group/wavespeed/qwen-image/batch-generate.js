...
const RESULTS_DIR = 'control_group/wavespeed/qwen-image/results';
...
async function processPrompts() {
  console.log("🎨 Starting WaveSpeed Qwen batch image generation from prompts.txt");
  ...
  try {
    ...
    for (let i = 0; i < prompts.length; i++) {
      ...
      try {
        ...
        // Generate image with WaveSpeed Qwen
    ...
    // Save summary report
    const reportText = `# WaveSpeed Qwen Batch Image Generation Report
...
`;
    ...
    console.log("\n🎉 WaveSpeed Qwen batch processing completed!");
    ...
    console.error("❌ WaveSpeed Qwen batch processing failed:", error.message);
    throw error;
  }
}
