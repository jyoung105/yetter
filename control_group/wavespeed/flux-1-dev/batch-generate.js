...
const RESULTS_DIR = 'control_group/wavespeed/flux-1-dev/results';
...
async function processPrompts() {
  console.log("🎨 Starting WaveSpeed Flux-Dev Ultra-Fast batch image generation from prompts.txt");
  ...
  try {
    ...
    for (let i = 0; i < prompts.length; i++) {
      ...
      try {
        ...
        // Generate image with WaveSpeed Flux-Dev (optimized settings)
    ...
    // Save summary report
    const reportText = `# WaveSpeed Flux-Dev Batch Image Generation Report
...
`;
    ...
    console.log("\n🎉 WaveSpeed Flux-Dev Ultra-Fast batch processing completed!");
    ...
    console.error("❌ WaveSpeed Flux-Dev batch processing failed:", error.message);
    throw error;
  }
}
